...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 15, fontWeight: '700', color: '#0F172A', textAlign: 'left', marginBottom: 12 },
  ...
  branchHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 },
  branchNameBlock: { flex: 1, alignItems: 'flex-start' },
  branchName: { fontSize: 15, fontWeight: '700', color: '#0F172A', textAlign: 'left' },
  ...
  infoText: { fontSize: 13, color: '#64748B', textAlign: 'left', flex: 1, marginRight: 6 },
  branchFooter: { flexDirection: 'row', alignItems: 'center', marginTop: 10, gap: 10 },
  callBtn: {
