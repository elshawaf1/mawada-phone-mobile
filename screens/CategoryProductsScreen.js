...
const styles = StyleSheet.create({
  ...
  sheetTitle: { fontSize: FONT_SIZES.xl, fontWeight: FONT_WEIGHTS.bold, color: COLORS.text, textAlign: 'left', paddingHorizontal: SPACING.xl, marginBottom: 8 },
  sheetFilterHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingRight: SPACING.xl },
  ...
  filterSectionLabel: { fontSize: FONT_SIZES.md, fontWeight: FONT_WEIGHTS.bold, color: COLORS.textSecondary, textAlign: 'left', paddingHorizontal: SPACING.xl, marginBottom: 4, marginTop: 8 },
  sortOption: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 14, paddingHorizontal: SPACING.xl },
  ...
  priceRangeRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: SPACING.xl, gap: 8, marginTop: 8 },
  priceInput: { flex: 1 },
  priceInputLabel: { fontSize: FONT_SIZES.sm, color: COLORS.textSecondary, textAlign: 'left', marginBottom: 4 },
